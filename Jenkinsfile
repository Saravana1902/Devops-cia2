  ...
  post {
    success {
      script {
        ...
        def gitMessage = sh(script: "git log -1 --pretty=%B || echo 'N/A'", returnStdout: true).trim()
          ...
          body: """
            ...
            <body style="font-family:Arial, sans-serif;">
              ...
              <table border="1" cellspacing="0" cellpadding="6" style="border-collapse:collapse; width:85%;">
                ...
                <tr><th align="left">Git Commit:</th><td>${gitCommit}</td></tr>
                <tr><th align="left">Commit Message:</th><td>${gitMessage}</td></tr>
